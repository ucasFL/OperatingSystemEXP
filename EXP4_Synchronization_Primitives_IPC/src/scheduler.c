...
void scheduler(){
	 ...
	 //if (current_running->status != EXITED)
	 //  break;
	 //}
	 //printf(current_running->pid+5, current_running->pid+5, "%d", current_running->pid);
...
void block(node_t * wait_queue){
	 ...
	 //current_running->block_queue = wait_queue;
	 //printf (12, 1, "%d", current_running->pid);
